...
print("\rTest", end="", flush=True)
print(", done.", end="\n", flush=False)
print("\rTest", end="", flush=True)
print(", done.", end="\n", flush=False)
# print("Updating {}, -0!", flush=False, end="\n")
# print("Updating {}, 0!", flush=False, end="\n")
# print("Updating {}, 1!", flush=True, end="")
# print("Updating {}, 2!", flush=False, end="\n")
# print("Updating {}, 30!", flush=True, end="")
# print("Updating {}, 31!", flush=True, end="")
# print("Updating {}, 4!", flush=False, end="\n")
# print("Updating {}, 5!", flush=True, end="")
