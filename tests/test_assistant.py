...
class TestAssistant(BaseUnitTest):
    ...
    def test_same_folder_name_and_course_key(self):
        ...
        self.assertTrue(
            self.assistant.are_similar(folder_name, course_key, course_name)
        )
    ...
    def test_assignments_sub_folder(self):
        ...
        self.assertEqual(
            self.assistant.found_assignments_sub_folder(folder_name, sub_folders),
            expected_path,
        )
    ...
    def test_kit_folder_no_subfolders(self):
        ...
        self.assertEqual(
            self.assistant.search_for_assignments_folder(folder_name, sub_folders),
            expected_result,
        )
    ...
    def test_kit_folder_with_subfolders(self):
        ...
        expected_result = {
            "course_key": "prg",
            "folder_name": os.path.join("Programmieren", "Übungen"),
        }
        self.assertEqual(
            self.assistant.search_for_assignments_folder(course_folder, sub_folders),
            expected_result,
        )
    ...
    def test_create_download_folder_should_create_course_subfolders(self):
        ...
        self.assistant.create_download_folder(assignment_folders, self.root_path)
        expected_la_folder = os.path.join(
            self.root_path, "Downloads", self.full_course_name("la")
        )
        expected_hm_folder = os.path.join(
            self.root_path, "Downloads", self.full_course_name("hm")
        )
    ...
    def test_download_folder_should_create_subfolders_slash_in_course_name(self):
        ...
        expected_gbi_folder = os.path.join(
            self.root_path, "Downloads", expected_course_name
        )
